...
// end section where we are choosing the code
     ...
     document.addEventListener('DOMContentLoaded', function() {
        ...
        fetch(`https://directoryapi.wigg.illinois.edu/Api/Area/Code/${code}`, {
            ...
            for (var i = 0; i < data.offices.length; i++) {
                ...
                } else if (data.offices[i].officeType == 'Research' || data.offices[i].officeType == 'Community Engagement') {
                    if (data.offices[i].priority == 1) {
                        filterResearchHigh.push(data.offices[i].title);
                    } else {
                        filterResearch.push(data.offices[i].title);
                    }
            ...
            document.getElementById('ilw-filter-research').setAttribute('allvalues', filterResearchHigh.concat(filterResearch.sort()).join('[-]'));
    ...
    function remove(category, item) {
        ...
        else if (category == 'offices4') {
            var searchParams = new URLSearchParams(window.location.search);
            searchParams.delete('offices4');
    ...
    function searchByName(e, displaytype, code, offices4) {
        ...
        if (jsonFilters != null) {
            ...
            if (jsonFilters.offices2 != '') {
                offices = offices != '' ? offices + encodeURIComponent('[-]') + encodeURIComponent(jsonFilters.offices2 ?? '') : encodeURIComponent(jsonFilters.offices2 ?? '');
            }
    ...
    function clearAndAddFilters(profileResults, jsonFilters, offices4) {
        ...
        if (jsonFilters != null) {
            ...
            addFilter(filterDiv, 'offices2', jsonFilters.offices2);
    ...
    function createDirectory(offices, profileResults) {
        ...
        let researchTitle = document.createElement('ilw-content');
        researchTitle.innerHTML = '<h2>Research Centers & Outreach Units</h2>';
        ...
        if (research.children.length > 1) {
            accordion.appendChild(research);
        }
