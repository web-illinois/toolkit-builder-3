...
function search(e) {
    ...
    let url = `https://resourceapi.wigg.illinois.edu/api/PersonSearch?take=1000&source=${code}&q=${searchQuery}&tag1=${tag1}&tag2=${tag2}&tag3=${tag3}&tag4=${tag4}&topic=${topic}&audience=${audience}&department=${department}`;
    fetch(url, {
        method: 'GET',
        headers: {
            "Content-type": "application/x-www-form-urlencoded; charset=UTF-8"
