---
title: Org Chart Information - Development
layout: components/base.liquid
permalink: "component/ilw-org-chart/custom-dev/index.html"
scripturl: "//dev.toolkit.illinois.edu/ilw-org-chart/latest/ilw-org-chart.js"
stylesheeturl: "//dev.toolkit.illinois.edu/ilw-org-chart/latest/ilw-org-chart.css"
---
<script type="module">
...
<p>The Organization Chart has a different structure than the typical component. This is because the org-chart has a JSON import function that allows you to generate the organization chart. </p><p>This is using the <strong>development</strong> version of the org chart.</p>
